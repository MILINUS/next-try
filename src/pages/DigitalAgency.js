  ...
  return (
    <>
      ...
      <main className="page-wrapper main_layout" >
        ...
        <div style={{background:"#ececec"}} className="r-header r-header-inner r-header-strip-01 ">
          {/* Start Slider Area  */}
          <Slider
        ...
        <div style={{background:"#ececec"}} className="search_media special-search-media">
        ...
        {/* <Separator /> */}
        <div style={{background:"#ececec"}} className="blog-area rn-section-gap">
          <div className="container">
            <div className="row">
              <div className="col-lg-12">
                <SectionTitle
