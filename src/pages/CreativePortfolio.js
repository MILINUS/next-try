                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    <h4 className="subtitle rn-sub-badge"><span class="theme-gradient">Portfolio Box Layout</span></h4>
                                    <h1 className="title">CARS RENTAL PARIS Creative Portfolio <br /> For Build Website.</h1>
